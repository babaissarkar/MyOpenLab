...
public class Start extends MainFlow {
    ...
    private void evalMethodExpression(String expression) {
        // SS : The start element is actually a method definition like below :
        ...
        if (idx1 > -1) {
            ...
            if (idx2 > -1) {
               ...
               // System.out.println("Definitionen : " + varDef);
                ...
                // The circuit will still work, so changing this to warning
//                element.jShowMessage("WARNING : could not find \")\"  example: main(String args)");
//                  Creating a method based on available info : 'Start('. Expression has only '('.
                methodName = expression.substring(0, idx1);
            }
        } else {
            // The circuit will still work, so changing this to warning
//            element.jShowMessage("WARNING : coud not find \"(\" example: main(String args)");
//                  Creating a method based on available info : Start. The expression has neither '(' nor ')'.
