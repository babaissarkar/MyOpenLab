...
public class StatusLineHoritontal extends Object implements StatusBasisIF
{
    ...
    private void createCursors()
    {
        ...
        img = vmobject.getToolkit().createImage(getClass().getResource("/Assets/Bilder/gif/Check.gif"));
        CheckCursor = vmobject.getToolkit().createCustomCursor(img, new Point(4,4), "CheckOK");
        
        img = vmobject.getToolkit().createImage(getClass().getResource("/Assets/Bilder/gif/Cross.gif"));
        CrossCursor = vmobject.getToolkit().createCustomCursor(img, new Point(4,4), "CrossX");
    }
