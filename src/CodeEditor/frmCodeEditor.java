...
public class frmCodeEditor extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jmniSaveProject.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
...
// TODO add your handling code here:
    ...
    public void execute(String elementPath, String elementLocation, String elementname)
    {
        ...
        //System.err.println("Element Paths " + elementPath + "  " + elementLocation);
    ...
    public void loadFile(String filename)
    {
        ...
        String caption = Path.of(filename).getFileName().toString();
        ImageIcon icon = new ImageIcon(getClass().getResource("/Assets/Bilder/16x16/page_java.gif"));
        
        jTabbedPane1.addTab(caption, icon, pnl, caption);
