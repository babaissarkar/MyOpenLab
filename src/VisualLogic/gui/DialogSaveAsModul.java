...
public class DialogSaveAsModul extends javax.swing.JDialog implements ElementPaletteIF {
    ...
    public void executeNewDirectory() {
        ...
        setTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/ElementPalette").getString("New_Directory"));
    ...
    public void executeEditDirectory(String directory) {
        ...
        setTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/ElementPalette").getString("edit_dir"));
        jPanel9.setVisible(false);
    ...
    public void executeEdit(String baseDir) {
        ...
        editBaseDir = baseDir;
        setTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/ElementPalette").getString("Menu_Edit"));
        txtName.setEnabled(false);
        ...
        if (result) {
            ...
            if (!ff1.equalsIgnoreCase(ff2)) {
                ...
                try {
                    ...
                    Tools.showMessage(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogSaveAsModul").getString("ERROR: COPYING ICON FILE!"));
                }
            }
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle1 = java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogSaveAsModul"); // NOI18N
        ...
        java.util.ResourceBundle bundle2 = java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/frmOptions"); // NOI18N
