...
public class DialogNewProject extends javax.swing.JDialog
{
    ...
    {//GEN-HEADEREND:event_ExploreFolder_btnActionPerformed
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewProject").getString("Browse..."));
    ...
    {//GEN-HEADEREND:event_Ok_btnActionPerformed
        ...
        else
        {
            ...
            Tools.showMessage(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewProject").getString("Folder_already_exist_:_")+"\""+projectName+"\"");
        }
