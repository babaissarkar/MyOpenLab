...
public class DialogAddEditvariable extends javax.swing.JDialog {
    ...
    public static void executeAdd(java.awt.Frame parent) {
        ...
        frm.setTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogAddEditvariable").getString("ADD VARIABLE"));
    ...
    public static void executeEdit(java.awt.Frame parent, OpenVariable node) {
        DialogAddEditvariable frm = new DialogAddEditvariable(parent, true);
        frm.setTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogAddEditvariable").getString("EDIT VARIABLE"));
