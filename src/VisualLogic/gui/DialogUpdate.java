...
public class DialogUpdate extends javax.swing.JDialog
{
    ...
    public DialogUpdate(FrameMain parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        jLabel1.setText(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Press_Start_Download_to_begin"));
        ...
        new Thread()
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    jLabel1.setText(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Download_completed!"));
                    jButton2.setText(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Close"));
                    
                    Tools.showMessage(DialogUpdate.this,java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Please_restart_the_Application!"), JOptionPane.INFORMATION_MESSAGE);
                    Tools.appResult=10;
                    dispose();
    ...
    private boolean close()
    {
        if (downloadInProgress)
        {
            ...
            int result = JOptionPane.showConfirmDialog((Component)null, java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Stop_Download?"), java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Attention!"), JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate"); // NOI18N
        ...
        if (downloadVersionFile("http://www.myopenlab.de/downloads/update.txt", supdateTXT))
        {
           ...
           }catch(Exception ex)
           {
            ...
            {        
                ...
                jLabel1.setText(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("Downloading...._(Please_Wait)"));
            } else
            {
                Tools.showMessage(DialogUpdate.this,java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogUpdate").getString("No_Updates_avaible"), JOptionPane.INFORMATION_MESSAGE);
