...
public class DialogNewJavaComponentAssistent extends javax.swing.JDialog implements ElementPaletteIF
{
    ...
    public DialogNewJavaComponentAssistent(FrameMain frameCircuit, boolean modal)
    {
        ...
        col1.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Name"));

        TableColumn col2=modCol.getColumn(1);
        col2.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("DataType"));

        TableColumn col3=modCol.getColumn(2);
        col3.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Min(Only Numerik)"));

        TableColumn col4=modCol.getColumn(3);
        col4.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Max(Only Numerik)"));
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent"); // NOI18N
    ...
    {//GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Save_Settings"));
    ...
    {//GEN-HEADEREND:event_jButton3ActionPerformed
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Load_Settings"));              
        chooser.addChoosableFileFilter(new javax.swing.filechooser.FileFilter()
        {
            ...
            public String getDescription()
            { return java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("JavaElement_Settings_Data_(javaelementconfig)"); }
        });
...
// TODO add your handling code here:
    ...
    private void loadSettings()
    {
        ...
        {
            Tools.showMessage(this,java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Error_loading_Configuration!"));
        }
    }
    ...
    {//GEN-HEADEREND:event_jButton2ActionPerformed
        ...
        {
            Tools.showMessage(this,java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/Messages").getString("Name is recommended"));
            return;
        }
        ...
        if (new File(str).exists())
        {
            ...
            Tools.showMessage(this, java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/DialogNewJavaComponentAssistent").getString("Directory_already_exists")+" : "+compName);
            return;
        }
