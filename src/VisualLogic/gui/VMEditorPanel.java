...
public class VMEditorPanel extends javax.swing.JPanel implements ElementPaletteIF
{
    ...
    private void loadDoc(String filename, JEditorPane pane)
    {
        ...
        else
        {
            ...
            pane.setText(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("Keine Beschreibung gefunden"));*/
        }
    ...
    public VMEditorPanel(VMEditorPanelIF owner, Basis basis,String elementPath, boolean panelMode)
    {
        ...
        //cmbProcessing.addItem(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("topFirst"));
        //cmbProcessing.addItem(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("bottomFirst"));
        ...
        //jTabPE.addTab(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("Property-Editor"), propertyEditor);
    ...
    public void saveJpg()
    {
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("Exportieren_als_JPG"));
        chooser.setDialogType(JFileChooser.SAVE_DIALOG);
        
        SimpleFilter filter = new SimpleFilter("jpg", java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("JPEG_Image_Files"));
        ...
        if (value == JFileChooser.APPROVE_OPTION)
        {
            ...
            {
                basis.showErrorMessage(java.util.ResourceBundle.getBundle("VisualLogic/NOI18N/FrameCircuit").getString("error_save_JPG"));
            }
        }
